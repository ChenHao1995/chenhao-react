    ...
    /***/ (function (module, exports) {
        ...
        */
        (function (S, K) { "object" === typeof module && module.exports ? module.exports = S.document ? K(S) : K : S.Highcharts = K(S); })("undefined" !== typeof window ? window : this, function (S) {
            var K = function () {
                var a = "undefined" === typeof S ? window : S, B = a.document, H = a.navigator && a.navigator.userAgent || "", E = B && B.createElementNS && !!B.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, q = /(edge|msie|trident)/i.test(H) && !a.opera, f = -1 !== H.indexOf("Firefox"), l = -1 !== H.indexOf("Chrome"), t = f && 4 > parseInt(H.split("Firefox/")[1], 10);
            ...
            (function (a) {
                ...
                a.error = function (q, f) { q = a.isNumber(q) ? "Highcharts error #" + q + ": www.highcharts.com/errors/" + q : q; if (f)
                    throw Error(q); E.console && console.log(q); };
                a.Fx = function (a, f, l) { this.options = f; this.elem = a; this.prop = l; };
                a.Fx.prototype = { dSetter: function () {
                    ...
                    }, update: function () { var a = this.elem, f = this.prop, l = this.now, t = this.options.step; if (this[f + "Setter"])
                        this[f + "Setter"]();
                    else
                        a.attr ? a.element && a.attr(f, l, null, !0) : a.style[f] = l + this.unit; t && t.call(a, l, this); }, run: function (q, f, l) {
                        var t = this, n = t.options, v = function (a) { return v.stopped ? !1 : t.step(a); }, u = E.requestAnimationFrame || function (a) { setTimeout(a, 13); }, c = function () { for (var b = 0; b < a.timers.length; b++)
                            a.timers[b]() || a.timers.splice(b--, 1); a.timers.length && u(c); };
                ...
                a.merge = function () { var q, f = arguments, l, t = {}, n = function (l, q) { "object" !== typeof l && (l = {}); a.objectEach(q, function (c, b) { !a.isObject(c, !0) || a.isClass(c) || a.isDOMElement(c) ? l[b] = q[b] : l[b] = n(l[b] || {}, c); }); return l; }; !0 === f[0] && (t = f[1], f = Array.prototype.slice.call(f, 2)); l = f.length; for (q = 0; q < l; q++)
                    t = n(t, f[q]); return t; };
                ...
                a.erase = function (a, f) { for (var l = a.length; l--;)
                    if (a[l] === f) {
                        a.splice(l, 1);
                        break;
                    } };
                a.defined = function (a) { return void 0 !== a && null !== a; };
                a.attr = function (q, f, l) { var t; a.isString(f) ? a.defined(l) ? q.setAttribute(f, l) : q && q.getAttribute && (t = q.getAttribute(f)) : a.defined(f) && a.isObject(f) && a.objectEach(f, function (a, l) { q.setAttribute(l, a); }); return t; };
                ...
                a.extend = function (a, f) { var l; a || (a = {}); for (l in f)
                    a[l] = f[l]; return a; };
                a.pick = function () { var a = arguments, f, l, t = a.length; for (f = 0; f < t; f++)
                    if (l = a[f], void 0 !== l && null !== l)
                        return l; };
                a.css = function (q, f) { a.isMS && !a.svg && f && void 0 !== f.opacity && (f.filter = "alpha(opacity\x3d" + 100 * f.opacity + ")"); a.extend(q.style, f); };
                a.createElement = function (q, f, l, t, n) { q = H.createElement(q); var v = a.css; f && a.extend(q, f); n && v(q, { padding: 0, border: "none", margin: 0 }); l && v(q, l); t && t.appendChild(q); return q; };
                a.extendClass = function (q, f) { var l = function () { }; l.prototype = new q; a.extend(l.prototype, f); return l; };
                ...
                a.wrap = function (a, f, l) { var t = a[f]; a[f] = function () { var a = Array.prototype.slice.call(arguments), v = arguments, u = this; u.proceed = function () { t.apply(u, arguments.length ? arguments : v); }; a.unshift(t); a = l.apply(this, a); u.proceed = null; return a; }; };
                a.formatSingle = function (q, f, l) { var t = /\.([0-9])/, n = a.defaultOptions.lang; /f$/.test(q) ? (l = (l = q.match(t)) ? l[1] : -1, null !== f && (f = a.numberFormat(f, l, n.decimalPoint, -1 < q.indexOf(",") ? n.thousandsSep : ""))) : f = (l || a.time).dateFormat(q, f); return f; };
                ...
                a.normalizeTickInterval = function (q, f, l, t, n) { var v, u = q; l = a.pick(l, 1); v = q / l; f || (f = n ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === t && (1 === l ? f = a.grep(f, function (a) { return 0 === a % 1; }) : .1 >= l && (f = [1 / l]))); for (t = 0; t < f.length && !(u = f[t], n && u * l >= q || !n && v <= (f[t] + (f[t + 1] || f[t])) / 2); t++)
                    ; return u = a.correctFloat(u * l, -Math.round(Math.log(.001) / Math.LN10)); };
                a.stableSort = function (a, f) {
                    var l = a.length, t, n;
                    for (n = 0; n < l; n++)
                        a[n].safeI = n;
                    a.sort(function (a, l) { t = f(a, l); return 0 === t ? a.safeI - l.safeI : t; });
                    for (n = 0; n < l; n++)
                        delete a[n].safeI;
                };
                a.arrayMin = function (a) { for (var f = a.length, l = a[0]; f--;)
                    a[f] < l && (l = a[f]); return l; };
                a.arrayMax = function (a) { for (var f = a.length, l = a[0]; f--;)
                    a[f] > l && (l = a[f]); return l; };
                a.destroyObjectProperties = function (q, f) { a.objectEach(q, function (a, t) { a && a !== f && a.destroy && a.destroy(); delete q[t]; }); };
                ...
                a.numberFormat = function (q, f, l, t) {
                    q = +q || 0;
                    f = +f;
                    var n = a.defaultOptions.lang, v = (q.toString().split(".")[1] || "").split("e")[0].length, u, c, b = q.toString().split("e");
                ...
                a.find = Array.prototype.find ? function (a, f) { return a.find(f); } : function (a, f) { var l, t = a.length; for (l = 0; l < t; l++)
                    if (f(a[l], l))
                        return a[l]; };
                a.map = function (a, f) { for (var l = [], t = 0, n = a.length; t < n; t++)
                    l[t] = f.call(a[t], a[t], t, a); return l; };
                ...
                a.offset = function (a) { var f = H.documentElement; a = a.parentElement ? a.getBoundingClientRect() : { top: 0, left: 0 }; return { top: a.top + (E.pageYOffset || f.scrollTop) - (f.clientTop || 0), left: a.left + (E.pageXOffset || f.scrollLeft) - (f.clientLeft || 0) }; };
                a.stop = function (q, f) { for (var l = a.timers.length; l--;)
                    a.timers[l].elem !== q || f && f !== a.timers[l].prop || (a.timers[l].stopped = !0); };
                a.each = function (q, f, l) { return (a.forEachPolyfill || Array.prototype.forEach).call(q, f, l); };
                a.objectEach = function (a, f, l) { for (var t in a)
                    a.hasOwnProperty(t) && f.call(l, a[t], t, a); };
                a.isPrototype = function (q) { return q === a.Axis.prototype || q === a.Chart.prototype || q === a.Point.prototype || q === a.Series.prototype || q === a.Tick.prototype; };
                a.addEvent = function (q, f, l) { var t, n = q.addEventListener || a.addEventListenerPolyfill; t = a.isPrototype(q) ? "protoEvents" : "hcEvents"; t = q[t] = q[t] || {}; n && n.call(q, f, l, !1); t[f] || (t[f] = []); t[f].push(l); return function () { a.removeEvent(q, f, l); }; };
                a.removeEvent = function (q, f, l) {
                    ...
                    function n(c) { var b, m; q.nodeName && (f ? (b = {}, b[f] = !0) : b = c, a.objectEach(b, function (a, h) { if (c[h])
                        for (m = c[h].length; m--;)
                            t(h, c[h][m]); })); }
                    var v, u;
                    a.each(["protoEvents", "hcEvents"], function (c) { var b = q[c]; b && (f ? (v = b[f] || [], l ? (u = a.inArray(l, v), -1 < u && (v.splice(u, 1), b[f] = v), t(f, l)) : (n(b), b[f] = [])) : (n(b), q[c] = {})); });
                };
                a.fireEvent = function (q, f, l, t) {
                    var n, v, u, c, b;
                    l = l || {};
                    H.createEvent && (q.dispatchEvent || q.fireEvent) ? (n = H.createEvent("Events"), n.initEvent(f, !0, !0),
                        a.extend(n, l), q.dispatchEvent ? q.dispatchEvent(n) : q.fireEvent(f, n)) : a.each(["protoEvents", "hcEvents"], function (m) { if (q[m])
                        for (v = q[m][f] || [], u = v.length, l.target || a.extend(l, { preventDefault: function () { l.defaultPrevented = !0; }, target: q, type: f }), c = 0; c < u; c++)
                ...
                a.animate = function (q, f, l) {
                    ...
                    l.curAnim = a.merge(f);
                    a.objectEach(f, function (c, m) { a.stop(q, m); u = new a.Fx(q, l, m); v = null; "d" === m ? (u.paths = u.initPath(q, q.d, f.d), u.toD = f.d, t = 0, v = 1) : q.attr ? t = q.attr(m) : (t = parseFloat(a.getStyle(q, m)) || 0, "opacity" !== m && (n = "px")); v || (v = c); v && v.match && v.match("px") && (v = v.replace(/px/g, "")); u.run(t, v, n); });
                };
                ...
                a.uniqueKey = function () { var a = Math.random().toString(36).substring(2, 9), f = 0; return function () { return "highcharts-" + a + "-" + f++; }; }();
                E.jQuery && (E.jQuery.fn.highcharts = function () { var q = [].slice.call(arguments); if (this[0])
            ...
            (function (a) {
                ...
                a.Color.prototype = { parsers: [{ regex: /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, parse: function (a) { return [f(a[1]), f(a[2]), f(a[3]), parseFloat(a[4], 10)]; } }, { regex: /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, parse: function (a) { return [f(a[1]), f(a[2]), f(a[3]), 1]; } }], names: { none: "rgba(255,255,255,0)", white: "#ffffff", black: "#000000" }, init: function (l) {
                        var f, n, v, u;
                        if ((this.input = l = this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) && l.stops)
                            this.stops = E(l.stops, function (c) { return new a.Color(c[1]); });
                        ...
                        this.stops ?
                            (v = q(l), v.stops = [].concat(v.stops), B(this.stops, function (n, c) { v.stops[c] = [v.stops[c][0], n.get(a)]; })) : v = n && H(n[0]) ? "rgb" === a || !a && 1 === n[3] ? "rgb(" + n[0] + "," + n[1] + "," + n[2] + ")" : "a" === a ? n[3] : "rgba(" + n.join(",") + ")" : l;
                        return v;
                    }, brighten: function (a) { var l, n = this.rgba; if (this.stops)
                        B(this.stops, function (n) { n.brighten(a); });
                    else if (H(a) && 0 !== a)
                        for (l = 0; 3 > l; l++)
                            n[l] += f(255 * a), 0 > n[l] && (n[l] = 0), 255 < n[l] && (n[l] = 255); return this; }, setOpacity: function (a) { this.rgba[3] = a; return this; }, tweenTo: function (a, f) {
            ...
            (function (a) {
                ...
                h(B.prototype, { opacity: 1, SVG_NS: N, textProps: "direction fontSize fontWeight fontFamily fontStyle color lineHeight width textAlign textDecoration textOverflow textOutline".split(" "), init: function (a, g) {
                        ...
                        if ((h = y[0]) && "none" !== h && a.svg) {
                            ...
                            h = h.replace(/(^[\d\.]+)(.*?)$/g, function (a, y, g) { return 2 * y + g; });
                            for (b = y.length; b--;)
                                c = y[b], "highcharts-text-outline" ===
                                    c.getAttribute("class") && k(y, g.removeChild(c));
                            e = g.firstChild;
                            d(y, function (a, y) { 0 === y && (a.setAttribute("x", g.getAttribute("x")), y = g.getAttribute("y"), a.setAttribute("y", y || 0), null === y && g.setAttribute("y", 0)); a = a.cloneNode(1); f(a, { "class": "highcharts-text-outline", fill: w, stroke: w, "stroke-width": h, "stroke-linejoin": "round" }); g.insertBefore(a, e); });
                        }
                    }, attr: function (a, g, c, w) {
                        var y, h = this.element, b, e = this, d, k;
                        "string" === typeof a && void 0 !== g && (y = a, a = {}, a[y] = g);
                        "string" === typeof a ? e = (this[a + "Getter"] || this._defaultGetter).call(this, a, h) : (J(a, function (y, g) { d = !1; w || L(this, g); this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(g) && (b || (this.symbolAttr(a), b = !0), d = !0); !this.rotation || "x" !== g && "y" !== g || (this.doTransform = !0); d || (k = this[g + "Setter"] || this._defaultSetter, k.call(this, y, g, h), this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(g) && this.updateShadows(g, y, k)); }, this), this.afterSetters());
                        c && c.call(this);
                        return e;
                    }, afterSetters: function () {
                        this.doTransform && (this.updateTransform(),
                            this.doTransform = !1);
                    }, updateShadows: function (a, g, c) { for (var y = this.shadows, w = y.length; w--;)
                        c.call(y[w], "height" === a ? Math.max(g - (y[w].cutHeight || 0), 0) : "d" === a ? this.d : g, a, y[w]); }, addClass: function (a, g) { var y = this.attr("class") || ""; -1 === y.indexOf(a) && (g || (a = (y + (y ? " " : "") + a).replace("  ", " ")), this.attr("class", a)); return this; }, hasClass: function (a) { return -1 !== r(a, (this.attr("class") || "").split(" ")); }, removeClass: function (a) { return this.attr("class", (this.attr("class") || "").replace(a, "")); }, symbolAttr: function (a) {
                        var y = this;
                        ...
                        y && J(a, function (a, g) { a !== y[g] && (c[g] = a, k = !0); });
                        k && (y && (a = h(y, c)), b = this.textWidth = a && a.width && "auto" !== a.width && "text" === w.nodeName.toLowerCase() && g(a.width), this.styles = a, b && !P && this.renderer.forExport && delete a.width, w.namespaceURI === this.SVG_NS ? (d = function (a, y) { return "-" + y.toLowerCase(); }, J(a, function (a, y) {
                            -1 ===
                        ...
                        p && "click" === a ? (c.ontouchstart = function (a) { y.touchEventFired = Date.now(); a.preventDefault(); g.call(c, a); }, c.onclick = function (a) {
                        ...
                        var a = this.translateX || 0, g = this.translateY || 0, c = this.scaleX, w = this.scaleY, h = this.inverted, e = this.rotation, b = this.matrix, d = this.element;
                    ...
                    align: function (a, g, c) {
                        ...
                        if (!a)
                            ...
                            for (w = 1; w <= d; w++)
                                h = e.cloneNode(0), b = 2 * d + 1 - 2 * w, f(h, { isShadow: "true", stroke: a.color || "#000000", "stroke-opacity": k * w, "stroke-width": b, transform: "translate" + p, fill: "none" }), c && (f(h, "height", Math.max(f(h, "height") - b, 0)), h.cutHeight = b), g ? g.element.appendChild(h) : e.parentNode && e.parentNode.insertBefore(h, e), y.push(h);
                            this.shadows = y;
                        }
                        return this;
                ...
                B.prototype.translateXSetter = B.prototype.translateYSetter = B.prototype.rotationSetter = B.prototype.verticalAlignSetter = B.prototype.rotationOriginXSetter = B.prototype.rotationOriginYSetter = B.prototype.scaleXSetter = B.prototype.scaleYSetter =
                    B.prototype.matrixSetter = function (a, g) { this[g] = a; this.doTransform = !0; };
                B.prototype["stroke-widthSetter"] = B.prototype.strokeSetter = function (a, g, c) { this[g] = a; this.stroke && this["stroke-width"] ? (B.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === g && 0 === a && this.hasStroke && (c.removeAttribute("stroke"), this.hasStroke = !1); };
                ...
                h(H.prototype, { Element: B, SVG_NS: N,
                    init: function (a, g, c, w, h, e) {
                        ...
                        this.setSize(g, c, !1);
                        var b;
                        z && a.getBoundingClientRect && (g = function () { n(a, { left: 0, top: 0 }); b = a.getBoundingClientRect(); n(a, { left: Math.ceil(b.left) - b.left + "px", top: Math.ceil(b.top) - b.top + "px" }); }, g(), this.unSubPixelFix = E(R, "resize", g));
                    }, getStyle: function (a) {
                        return this.style = h({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "12px" }, a);
                    ...
                    }, getSpanWidth: function (a) { return a.getBBox(!0).width; }, applyEllipsis: function (a, g, c, w) { var h = a.rotation, y = c, b, e = 0, d = c.length, k = function (a) { g.removeChild(g.firstChild); a && g.appendChild(m.createTextNode(a)); }, p; a.rotation = 0; y = this.getSpanWidth(a, g); if (p = y > w) {
                        for (; e <= d;)
                            b = Math.ceil((e + d) / 2), y = c.substring(0, b) + "\u2026", k(y), y = this.getSpanWidth(a, g), e === d ? e = d + 1 : y > w ? d = b - 1 : e = b;
                        0 === d && k("");
                    } a.rotation = h; return p; }, escapes: { "\x26": "\x26amp;", "\x3c": "\x26lt;", "\x3e": "\x26gt;", "'": "\x26#39;",
                        '"': "\x26quot;" }, buildText: function (a) {
                        var c = a.element, w = this, h = w.forExport, b = G(a.textStr, "").toString(), y = -1 !== b.indexOf("\x3c"), k = c.childNodes, p, x, A, F, z = f(c, "x"), L = a.styles, O = a.textWidth, l = L && L.lineHeight, D = L && L.textOutline, C = L && "ellipsis" === L.textOverflow, v = L && "nowrap" === L.whiteSpace, u = L && L.fontSize, M, t, I = k.length, L = O && !a.added && this.box, R = function (a) { var h; h = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : u || w.style.fontSize || 12; return l ? g(l) : w.fontMetrics(h, a.getAttribute("style") ? a : c).h; }, q = function (a, g) { J(w.escapes, function (c, w) { g && -1 !== r(c, g) || (a = a.toString().replace(new RegExp(c, "g"), w)); }); return a; };
                        M = [b, C, v, l, D, u, O].join();
                        if (M !== a.textCache) {
                            for (a.textCache = M; I--;)
                                c.removeChild(k[I]);
                            y || D || C || O || -1 !== b.indexOf(" ") ? (p = /<.*class="([^"]+)".*>/, x = /<.*style="([^"]+)".*>/, A = /<.*href="([^"]+)".*>/, L && L.appendChild(c), b = y ? b.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [b], b = e(b, function (a) { return "" !== a; }), d(b, function (g, b) {
                                var e, y = 0;
                        ...
                        r = k.style;
                        delete k.style;
                        E(y.element, M ? "mouseover" : "mouseenter", function () { 3 !== x && y.setState(1); });
                        E(y.element, M ? "mouseout" : "mouseleave", function () { 3 !== x && y.setState(x); });
                        y.setState = function (a) { 1 !== a && (y.state = x = a); y.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" + ["normal", "hover", "pressed", "disabled"][a || 0]); y.attr([b, d, e, k][a || 0]).css([N, m, A, r][a || 0]); };
                        y.attr(b).css(h({ cursor: "default" }, N));
                        return y.on("click", function (a) { 3 !== x && w.call(y, a); });
                    }, crispLine: function (a, g) { a[1] === a[4] && (a[1] = a[4] = Math.round(a[1]) - g % 2 / 2); a[2] === a[5] && (a[2] = a[5] = Math.round(a[2]) + g % 2 / 2); return a; }, path: function (a) { var g = { fill: "none" }; I(a) ? g.d = a : D(a) && h(g, a); return this.createElement("path").attr(g); }, circle: function (a, g, c) { a = D(a) ? a : { x: a, y: g, r: c }; g = this.createElement("circle"); g.xSetter = g.ySetter = function (a, g, c) { c.setAttribute("c" + g, a); }; return g.attr(a); }, arc: function (a, g, c, w, b, h) { D(a) ? (w = a, g = w.y, c = w.r, a = w.x) : w = { innerR: w, start: b, end: h }; a = this.symbol("arc", a, g, c, c, w); a.r = c; return a; }, rect: function (a, g, c, w, b, h) { b = D(a) ? a.r : b; var d = this.createElement("rect"); a = D(a) ? a : void 0 === a ? {} : { x: a, y: g, width: Math.max(c, 0), height: Math.max(w, 0) }; void 0 !== h && (a.strokeWidth = h, a = d.crisp(a)); a.fill = "none"; b && (a.r = b); d.rSetter = function (a, g, c) { f(c, { rx: a, ry: a }); }; return d.attr(a); }, setSize: function (a, g, c) {
                        var w = this.alignedObjects, b = w.length;
                        this.width = a;
                        this.height = g;
                        for (this.boxWrapper.animate({ width: a, height: g }, { step: function () { this.attr({ viewBox: "0 0 " + this.attr("width") + " " + this.attr("height") }); }, duration: G(c, !0) ?
                                void 0 : 0 }); b--;)
                            w[b].align();
                        ...
                        A ? (p = this.path(F), p.attr("fill", "none"), h(p, { symbolName: N, x: g, y: c, width: w, height: b }), e && h(p, e)) : x && (r = a.match(y)[1], p = this.image(r), p.imgwidth = G(O[r] && O[r].width, e && e.width), p.imgheight = G(O[r] && O[r].height, e && e.height), L = function () { p.attr({ width: p.width, height: p.height }); }, d(["width", "height"], function (a) {
                        ...
                        return p;
                            ...
                            return k;
                        } }, clipRect: function (g, c, w, b) { var h = a.uniqueKey(), d = this.createElement("clipPath").attr({ id: h }).add(this.defs); g = this.rect(g, c, w, b, 0).add(d); g.id = h; g.clipPath = d; g.count = 0; return g; }, text: function (a, g, c, w) {
                        var b = {};
                        ...
                        var A = this, r = A.g("button" !== m && "label"), y = r.text = A.text("", 0, 0, x).attr({ zIndex: 1 }), L, P, z = 0, O = 3, l = 0, n, D, f, J, C, G = {}, v, M, t = /^url\((.*?)\)$/.test(e), I = t, R, q, Q, T;
                        m && r.addClass("highcharts-" + m);
                        I = t;
                        R = function () { return (v || 0) % 2 / 2; };
                        q = function () {
                        ...
                        Q = function () { var a = l + O, g; g = N ? 0 : M; u(n) && P && ("center" === C || "right" === C) && (a += { center: .5, right: 1 }[C] * (n - P.width)); if (a !== y.x || g !== y.y)
                            y.attr("x", a), void 0 !== g && y.attr("y", g); y.x = a; y.y = g; };
                        T = function (a, g) { L ? L.attr(a, g) : G[a] = g; };
                        r.onAdd = function () { y.add(r); r.attr({ text: g || 0 === g ? g : "", x: c, y: b }); L && u(k) && r.attr({ anchorX: k, anchorY: p }); };
                        r.widthSetter = function (g) { n = a.isNumber(g) ? g : null; };
                        r.heightSetter = function (a) { D = a; };
                        r["text-alignSetter"] =
                            function (a) { C = a; };
                        r.paddingSetter = function (a) { u(a) && a !== O && (O = r.padding = a, Q()); };
                        r.paddingLeftSetter = function (a) { u(a) && a !== l && (l = a, Q()); };
                        r.alignSetter = function (a) { a = { left: 0, center: .5, right: 1 }[a]; a !== z && (z = a, P && r.attr({ x: f })); };
                        r.textSetter = function (a) { void 0 !== a && y.textSetter(a); q(); Q(); };
                        r["stroke-widthSetter"] = function (a, g) { a && (I = !0); v = this["stroke-width"] = a; T(g, a); };
                        r.strokeSetter = r.fillSetter = r.rSetter = function (a, g) { "r" !== g && ("fill" === g && a && (I = !0), r[g] = a); T(g, a); };
                        r.anchorXSetter = function (a, g) {
                            k = r.anchorX =
                                a;
                            T(g, Math.round(a) - R() - f);
                        };
                        r.anchorYSetter = function (a, g) { p = r.anchorY = a; T(g, a - J); };
                        r.xSetter = function (a) { r.x = a; z && (a -= z * ((n || P.width) + 2 * O)); f = Math.round(a); r.attr("translateX", f); };
                        r.ySetter = function (a) { J = r.y = Math.round(a); r.attr("translateY", J); };
                        var U = r.css;
                        return h(r, { css: function (a) { if (a) {
                                var g = {};
                                a = F(a);
                                d(r.textProps, function (c) { void 0 !== a[c] && (g[c] = a[c], delete a[c]); });
                                y.css(g);
                            } return U.call(r, a); }, getBBox: function () { return { width: P.width + 2 * O, height: P.height + 2 * O, x: P.x - O, y: P.y - O }; }, shadow: function (a) {
                                a &&
                                    (q(), L && L.shadow(a));
                                return r;
            ...
            (function (a) {
                ...
                l(a.SVGElement.prototype, { htmlCss: function (a) {
                        ...
                        if (this.added) {
                            var a = this.renderer, b = this.element, d = this.translateX || 0, p = this.translateY || 0, r = this.x || 0, m = this.y || 0, z = this.textAlign || "left", l = { left: 0, center: .5, right: 1 }[z], n = this.styles, C = n && n.whiteSpace;
                            E(b, { marginLeft: d, marginTop: p });
                            this.shadows && f(this.shadows, function (a) { E(a, { marginLeft: d + 1, marginTop: p + 1 }); });
                ...
                l(b.prototype, { getTransformKey: function () { return n && !/Edge/.test(m.navigator.userAgent) ? "-ms-transform" : v ? "-webkit-transform" : t ? "MozTransform" : m.opera ? "-o-transform" : ""; }, html: function (a, c, b) {
                        ...
                        e.textSetter = function (a) { a !== h.innerHTML && delete this.bBox; this.textStr = a; h.innerHTML = u(a, ""); e.doTransform = !0; };
                        m && n(e, e.element.style);
                        e.xSetter = e.ySetter = e.alignSetter = e.rotationSetter = function (a, c) { "align" === c && (c = "textAlign"); e[c] = a; e.doTransform = !0; };
                            ...
                            if (this.parentGroup = a) {
                                if (c = a.div, !c) {
                                    ...
                                    f(d.reverse(), function (a) {
                                        function h(g, c) { a[c] = g; "translateX" === c ? k.left = g + "px" : k.top = g + "px"; a.doTransform = !0; }
                                        var k, g = B(a.element, "class");
                                        g && (g = { className: g });
                                        c = a.div = a.div || H("div", g, { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px", display: a.display, opacity: a.opacity, pointerEvents: a.styles && a.styles.pointerEvents }, c || b);
                                        k = c.style;
                                        l(a, { classSetter: function (a) { return function (g) { this.element.setAttribute("class", g); a.className = g; }; }(c), on: function () { d[0].div && e.on.apply({ element: d[0].div }, arguments); return a; }, translateXSetter: h, translateYSetter: h });
                                        n(a, k);
                                    });
                                }
                            }
            ...
            (function (a) {
                ...
                a.Time.prototype = { defaultOptions: {},
                    update: function (n) {
                        ...
                        (this.variableTimezone = !(l && !n.getTimezoneOffset && !n.timezone)) || this.timezoneOffset ? (this.get = function (a, b) { var c = b.getTime(), d = c - u.getTimezoneOffset(b); b.setTime(d); a = b["getUTC" + a](); b.setTime(c); return a; }, this.set = function (c, b, m) {
                            var d;
                        ...
                        if (f.timezone) {
                            if (u)
                                return function (a) { return 6E4 * -u.tz(a, f.timezone).utcOffset(); };
                            a.error(25);
                        }
                        return this.useUTC && f.getTimezoneOffset ? function (a) { return 6E4 * f.getTimezoneOffset(a); } : function () {
                            return 6E4 *
                                (l.timezoneOffset || 0);
                        };
                        ...
                        a.objectEach(b, function (a, b) { for (; -1 !== l.indexOf("%" + b);)
            ...
            (function (a) {
                ...
                a.setOptions = function (B) { a.defaultOptions = H(!0, a.defaultOptions, B); a.time.update(H(a.defaultOptions.global, a.defaultOptions.time), !1); return a.defaultOptions; };
                a.getOptions = function () { return a.defaultOptions; };
                a.defaultPlotOptions = a.defaultOptions.plotOptions;
                a.time = new a.Time(H(a.defaultOptions.global, a.defaultOptions.time));
                a.dateFormat = function (B, q, f) { return a.time.dateFormat(B, q, f); };
            })(K);
            (function (a) {
                var B = a.correctFloat, H = a.defined, E = a.destroyObjectProperties, q = a.isNumber, f = a.merge, l = a.pick, t = a.deg2rad;
                a.Tick = function (a, l, f, c) { this.axis = a; this.pos = l; this.type = f || ""; this.isNewLabel = this.isNew = !0; f || c || this.addLabel(); };
            ...
            var V = function (a) {
                ...
                a.extend(G.prototype, { defaultOptions: { dateTimeLabelFormats: { millisecond: "%H:%M:%S.%L",
                    ...
                    defaultRightAxisOptions: { labels: { x: 15 }, title: { rotation: 90 } }, defaultBottomAxisOptions: { labels: { autoRotation: [-45], x: 0 }, title: { rotation: 0 } }, defaultTopAxisOptions: { labels: { autoRotation: [-45], x: 0 }, title: { rotation: 0 } }, init: function (a, c) {
                        ...
                        var g = this.axis, c = this.value, b = g.chart.time, e = g.categories, h = this.dateTimeLabelFormat, k = t.lang, p = k.numericSymbols, k = k.numericSymbolMagnitude || 1E3, x = p && p.length, r, m = g.options.labels.format, g = g.isLog ? Math.abs(c) : g.tickInterval;
                        if (m)
                            r = d(m, this, b);
                        else if (e)
                            r = c;
                        ...
                        k = this.transB;
                        var A = function (a, g, c) { if (a < g || a > c)
                            d ? a = Math.min(Math.max(g, a), c) : N = !0; return a; };
                    ...
                    }, getLinearTickPositions: function (a, c, b) { var g, w = l(Math.floor(c / a) * a); b = l(Math.ceil(b / a) * a); var d = [], e; l(w + a) === w && (e = 20); if (this.single)
                        return [c]; for (c = w; c <= b;) {
                        d.push(c);
                        c = l(c + a, e);
                        if (c === g)
                            break;
                        g = c;
                    } return d; }, getMinorTickInterval: function () { var a = this.options; return !0 === a.minorTicks ? C(a.minorTickInterval, "auto") : !1 === a.minorTicks ? null : a.minorTickInterval; },
                    getMinorTickPositions: function () { var a = this, b = a.options, d = a.tickPositions, e = a.minorTickInterval, h = [], k = a.pointRangePadding || 0, p = a.min - k, k = a.max + k, x = k - p; if (x && x / e < a.len / 3)
                        if (a.isLog)
                            c(this.paddedTicks, function (g, c, b) { c && h.push.apply(h, a.getLogTickPositions(e, b[c - 1], b[c], !0)); });
                            ...
                            for (b = p + (d[0] - p) % e; b <= k && b !== h[0]; b += e)
                                h.push(b); 0 !== h.length && a.trimTicks(h); return h; },
                    adjustForMinRange: function () {
                        var a = this.options, b = this.min, d = this.max, e, h, k, p, x, r, m, A;
                        this.isXAxis && void 0 === this.minRange && !this.isLog && (n(a.min) || n(a.max) ? this.minRange = null : (c(this.series, function (a) { r = a.xData; for (p = m = a.xIncrement ? 1 : r.length - 1; 0 < p; p--)
                            if (x = r[p] - r[p - 1], void 0 === k || x < k)
                                k = x; }), this.minRange = Math.min(5 * k, this.dataMax - this.dataMin)));
                        ...
                        0 < b.length && (c(a.keys(b.keys), function (a) { delete b.keys[a]; }), b.length = 0, this.minRange = this.userMinRange, c(this.series || [], function (a) {
                            a.xIncrement = null;
                        ...
                        if (m || x || d)
                            e = g.getClosest(), p ? (h = p.minPointOffset, k = p.pointRangePadding) : c(g.series, function (a) { var c = x ? 1 : m ? C(a.options.pointRange, e, 0) : g.axisPointRange || 0; a = a.options.pointPlacement; d = Math.max(d, c); g.single || (h = Math.max(h, I(a) ? 0 : c / 2), k = Math.max(k, "on" === a ? 0 : c)); }), p = g.ordinalSlope && e ? g.ordinalSlope /
                        ...
                        var b = this, d = b.chart, e = b.options, k = b.isLog, p = b.log2lin, x = b.isDatetimeAxis, A = b.isXAxis, F = b.isLinked, f = e.maxPadding, z = e.minPadding, D = e.tickInterval, J = e.tickPixelInterval, G = b.categories, u = b.threshold, t = b.softThreshold, v, q, I, B;
                        ...
                        A && !g && c(b.series, function (a) { a.processData(b.min !== b.oldMin || b.max !== b.oldMax); });
                    ...
                    }, trimTicks: function (a, b, c) { var g = a[0], d = a[a.length - 1], e = this.minPointOffset || 0; if (!this.isLinked) {
                        if (b && -Infinity !== g)
                            this.min = g;
                        else
                            for (; this.min - e > a[0];)
                        ...
                        !1 === this.chart.options.chart.alignTicks ||
                            !1 === d.alignTicks || this.isLog || c(this.chart[this.coll], function (g) { var c = g.options, c = [g.horiz ? c.left : c.top, c.width, c.height, c.pane].join(); g.series.length && (a[c] ? b = !0 : a[c] = 1); });
                        return b;
                        ...
                        var a = this.tickInterval, b = this.tickPositions, c = this.tickAmount, d = this.finalTickAmt, e = b && b.length, h = C(this.threshold, this.softThreshold ? 0 : null);
                        if (this.hasData()) {
                            if (e < c) {
                                for (; b.length < c;)
                        ...
                        c(this.series, function (b) { if (b.isDirtyData || b.isDirty || b.xAxis.isDirty)
                            a = !0; });
                    ...
                    }, autoLabelAlign: function (a) { a = (C(a, 0) - 90 * this.side + 720) % 360; return 15 < a && 165 > a ? "right" : 195 < a && 345 > a ? "left" : "center"; }, tickSize: function (a) { var b = this.options, c = b[a + "Length"], g = C(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0); if (g && c)
                        return "inside" === b[a + "Position"] && (c = -c), [c, g]; }, labelMetrics: function () {
                        var a = this.tickPositions && this.tickPositions[0] || 0;
                        return this.chart.renderer.fontMetrics(this.options.labels.style && this.options.labels.style.fontSize, this.ticks[a] && this.ticks[a].label);
                    }, unsquish: function () {
                        var a = this.options.labels, b = this.horiz, d = this.tickInterval, e = d, h = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), k, p = a.rotation, x = this.labelMetrics(), r, m = Number.MAX_VALUE, A, F = function (a) { a /= h || 1; a = 1 < a ? Math.ceil(a) : 1; return a * d; };
                        b ? (A = !a.staggerLines && !a.step && (n(p) ? [p] : h < C(a.autoRotationLimit, 80) && a.autoRotation)) && c(A, function (a) { var b; if (a === p || a && -90 <= a && 90 >= a)
                        ...
                        var a = this.chart, b = a.renderer, d = this.tickPositions, e = this.ticks, h = this.options.labels, k = this.horiz, p = this.getSlotWidth(), x = Math.max(1, Math.round(p - 2 * (h.padding || 5))), r = {}, m = this.labelMetrics(), A = h.style && h.style.textOverflow, F, l, f = 0, z;
                        I(h.rotation) || (r.rotation = h.rotation || 0);
                        c(d, function (a) { (a = e[a]) && a.label && a.label.textPxLength > f && (f = a.label.textPxLength); });
                        ...
                        if (this.autoRotation)
                            ...
                            for (l = "clip", x = d.length; !k && x--;)
                                if (z = d[x], z = e[z].label)
                                    z.styles && "ellipsis" === z.styles.textOverflow ? z.css({ textOverflow: "clip" }) :
                        ...
                        this.axisTitle || ((e = d.textAlign) || (e = (c ? { low: "left", middle: "center", high: "right" } : { low: g ? "right" : "left", middle: "center", high: g ? "left" : "right" })[d.align]), this.axisTitle = b.text(d.text, 0, 0, d.useHTML).attr({ zIndex: 7, rotation: d.rotation || 0, align: e }).addClass("highcharts-axis-title").css(z(d.style)).add(this.axisGroup), this.axisTitle.isNew = !0);
                        ...
                        var a = this, b = a.chart, d = b.renderer, e = a.options, h = a.tickPositions, k = a.ticks, p = a.horiz, x = a.side, r = b.inverted && !a.isZAxis ? [1, 0, 3, 2][x] : x, m, A, F = 0, l, f = 0, z = e.title, J = e.labels, G = 0, u = b.axisOffset, b = b.clipOffset, t = [-1, 1, 1, -1][x], v = e.className, M = a.axisParent, q = this.tickSize("tick");
                        m = a.hasData();
                        ...
                        m || a.isLinked ? (c(h, function (b, c) { a.generateTick(b, c); }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === x || 2 === x || { 1: "left", 3: "right" }[x] === a.labelAlign, C(J.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && c(h, function (a) { G = Math.max(k[a].getLabelSize(), G); }), a.staggerLines && (G *= a.staggerLines), a.labelOffset = G * (a.opposite ? -1 : 1)) : D(k, function (a, b) { a.destroy(); delete k[b]; });
                        ...
                        return { x: a ? d + x : b + (k ? this.width : 0) + p + x, y: a ? b + r - (k ? this.height : 0) + p :
                                d + r };
                    }, renderMinorTick: function (a) { var b = this.chart.hasRendered && r(this.oldMin), c = this.minorTicks; c[a] || (c[a] = new J(this, a, "minor")); b && c[a].isNew && c[a].render(null, !0); c[a].render(null, !1, 1); }, renderTick: function (a, b) { var c = this.isLinked, g = this.ticks, d = this.chart.hasRendered && r(this.oldMin); if (!c || a >= this.min && a <= this.max)
                        g[a] || (g[a] = new J(this, a)), d && g[a].isNew && g[a].render(b, !0, .1), g[a].render(b); }, render: function () {
                        var b = this, d = b.chart, e = b.options, h = b.isLog, k = b.lin2log, p = b.isLinked, x = b.tickPositions, m = b.axisTitle, F = b.ticks, l = b.minorTicks, f = b.alternateBands, z = e.stackLabels, G = e.alternateGridColor, n = b.tickmarkOffset, u = b.axisLine, C = b.showAxis, t = H(d.renderer.globalAnimation), v, M;
                        b.labelEdge.length = 0;
                        b.overlap = !1;
                        c([F, l, f], function (a) { D(a, function (a) { a.isActive = !1; }); });
                        if (b.hasData() || p)
                            b.minorTickInterval && !b.categories && c(b.getMinorTickPositions(), function (a) { b.renderMinorTick(a); }), x.length && (c(x, function (a, c) { b.renderTick(a, c); }), n && (0 === b.min || b.single) && (F[-1] || (F[-1] = new J(b, -1, null, !0)), F[-1].render(-1))),
                                G && c(x, function (c, e) { M = void 0 !== x[e + 1] ? x[e + 1] + n : b.max - n; 0 === e % 2 && c < b.max && M <= b.max + (d.polar ? -n : n) && (f[c] || (f[c] = new a.PlotLineOrBand(b)), v = c + n, f[c].options = { from: h ? k(v) : v, to: h ? k(M) : M, color: G }, f[c].render(), f[c].isActive = !0); }), b._addedPlotLB || (c((e.plotLines || []).concat(e.plotBands || []), function (a) { b.addPlotBandOrLine(a); }), b._addedPlotLB = !0);
                        c([F, l, f], function (a) {
                    ...
                    keepProps: "extKey hcEvents names series userMax userMin".split(" "), destroy: function (a) {
                        ...
                        a || x(b);
                        D(d, function (a, b) { u(a); d[b] = null; });
                        c([b.ticks, b.minorTicks, b.alternateBands], function (a) { u(a); });
                        if (g)
                            for (a = g.length; a--;)
                                g[a].destroy();
            ...
            (function (a) {
                var B = a.Axis, H = a.getMagnitude, E = a.normalizeTickInterval, q = a.timeUnits;
                B.prototype.getTimeTicks = function () { return this.chart.time.getTimeTicks.apply(this.chart.time, arguments); };
            ...
            (function (a) {
                ...
                B.prototype.getLogTickPositions = function (a, t, n, v) {
                    ...
                    if (.5 <= a)
                        ...
                        for (var c = Math.floor(t), h, k, e, p, r, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < n + 1 && !r; c++)
            ...
            (function (a, B) {
                ...
                a.PlotLineOrBand.prototype = { render: function () {
                        var f = this, c = f.axis, b = c.horiz, m = f.options, d = m.label, h = f.label, k = m.to, e = m.from, p = m.value, r = q(e) && q(k), l = q(p), z = f.svgElem, t = !z, D = [], C = m.color, x = v(m.zIndex, 0), F = m.events, D = { "class": "highcharts-plot-" + (r ? "band " : "line ") + (m.className || "") }, A = {}, J = c.chart.renderer, G = r ? "bands" : "lines", g = c.log2lin;
                        ...
                        if (l)
                            ...
                            return;
                        t && D && D.length ? (z.attr({ d: D }), F && a.objectEach(F, function (a, b) { z.on(b, function (a) { F[b].apply(f, [a]); }); })) : z && (D ? (z.show(), z.animate({ d: D })) : (z.hide(), h && (f.label = h = h.destroy())));
                        ...
                        return f;
                    }, renderLabel: function (a, c, b, m) { var d = this.label, h = this.axis.chart.renderer; d || (d = { align: a.textAlign || a.align, rotation: a.rotation, "class": "highcharts-plot-" + (b ? "band" : "line") + "-label " + (a.className || "") }, d.zIndex = m, this.label = d = h.text(a.text, 0, 0, a.useHTML).attr(d).add(), d.css(a.style)); m = c.xBounds || [c[1], c[4], b ? c[6] : c[1]]; c = c.yBounds || [c[2], c[5], b ? c[7] : c[2]]; b = E(m); h = E(c); d.align(a, !1, { x: b, y: h, width: H(m) - b, height: H(c) - h }); d.show(); }, destroy: function () { t(this.axis.plotLinesAndBands, this); delete this.axis; f(this); } };
                a.extend(B.prototype, { getPlotBandPath: function (a, c) { var b = this.getPlotLinePath(c, null, null, !0), m = this.getPlotLinePath(a, null, null, !0), d = [], h = this.horiz, k = 1, e; a = a < this.min && c < this.min || a > this.max && c > this.max; if (m && b)
                        for (a && (e = m.toString() === b.toString(), k = 0), a = 0; a < m.length; a += 6)
                            h && b[a + 1] === m[a + 1] ? (b[a + 1] += k, b[a + 4] += k) : h || b[a + 2] !== m[a + 2] || (b[a + 2] += k, b[a + 5] += k), d.push("M", m[a + 1], m[a + 2], "L", m[a + 4], m[a + 5], b[a + 4], b[a + 5], b[a + 1], b[a + 2], "z"), d.flat = e; return d; }, addPlotBand: function (a) { return this.addPlotBandOrLine(a, "plotBands"); },
            ...
            (function (a) {
                ...
                a.Tooltip.prototype = { init: function (a, b) { this.chart = a; this.options = b; this.crosshairs = []; this.now = { x: 0, y: 0 }; this.isHidden = !0; this.split = b.split && !a.inverted; this.shared = b.shared || this.split; },
                    ...
                    update: function (a) { this.destroy(); l(!0, this.chart.options.tooltip.userOptions, a); this.init(this.chart, l(!0, this.options, a)); }, destroy: function () { this.label && (this.label = this.label.destroy()); this.split && this.tt && (this.cleanSplit(this.chart, !0), this.tt = this.tt.destroy()); clearTimeout(this.hideTimer); clearTimeout(this.tooltipTimeout); }, move: function (a, b, m, d) {
                        ...
                        c.getLabel().attr(k);
                        e && (clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function () { c && c.move(a, b, m, d); }, 32));
                        ...
                        var c, d = this.chart, h = d.inverted, k = d.plotTop, e = d.plotLeft, p = 0, r = 0, l, z;
                        a = n(a);
                        c = a[0].tooltipPos;
                        this.followPointer && b && (void 0 === b.chartX && (b = d.pointer.normalize(b)), c = [b.chartX - d.plotLeft, b.chartY - k]);
                        c || (B(a, function (a) { l = a.series.yAxis; z = a.series.xAxis; p += a.plotX + (!h && z ? z.left - e : 0); r += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!h && l ? l.top - k : 0); }), p /= a.length, r /= a.length, c = [h ? d.plotWidth - r : p, this.shared && !h && 1 < a.length && b ? b.chartY - k : h ? d.plotHeight - p : r]);
                        return f(c, Math.round);
                    }, getPosition: function (a, b, m) {
                        var c = this.chart, h = this.distance, k = {}, e = c.inverted &&
                            m.h || 0, p, r = ["y", c.chartHeight, b, m.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight], f = ["x", c.chartWidth, a, m.plotX + c.plotLeft, c.plotLeft, c.plotLeft + c.plotWidth], l = !this.followPointer && t(m.ttBelow, !c.inverted === !!m.negative), n = function (a, b, c, d, g, p) { var x = c < d - h, r = d + h + c < b, m = d - h - c; d += h; if (l && r)
                            k[a] = d;
                        else if (!l && x)
                            k[a] = m;
                        else if (x)
                            ...
                            return !1; }, D = function (a, b, c, d) { var e; d < h || d > b - h ? e = !1 : k[a] = d < c / 2 ? 1 : d > b - c / 2 ? b - c - 2 : d - c / 2; return e; }, C = function (a) { var b = r; r = f; f = b; p = a; }, x = function () { !1 !== n.apply(0, r) ? !1 !== D.apply(0, f) || p || (C(!0), x()) : p ? k.x = k.y = 0 : (C(!0), x()); };
                        ...
                        B(d, function (a) {
                            ...
                            a.tt.attr({ visibility: void 0 === a.pos ? "hidden" : "inherit", x: e || b.isHeader ? a.x : b.plotX + h.plotLeft + t(p.distance, 16), y: a.pos + h.plotTop, anchorX: b.isHeader ? b.plotX + h.plotLeft : b.plotX + c.xAxis.pos, anchorY: b.isHeader ? a.pos + h.plotTop - 15 : b.plotY + c.yAxis.pos });
                        });
                        ...
                        b = b ? "footer" : "header";
                        var c = a.series, d = c.tooltipOptions, h = d.xDateFormat, k = c.xAxis, e = k && "datetime" === k.options.type && q(a.key), p = d[b + "Format"];
                        e && !h && (h = this.getXDateFormat(a, d, k));
                        e && h && B(a.point && a.point.tooltipDateKeys || ["key"], function (a) { p = p.replace("{point." + a + "}", "{point." + a + ":" + h + "}"); });
            ...
            (function (a) {
                ...
                a.Pointer.prototype = { init: function (a, b) { this.options = b; this.chart = a; this.runChartClick = b.chart.events && !!b.chart.events.click; this.pinchDown = []; this.lastValidTouch = {}; k && (a.tooltip = new k(a, b.tooltip), this.followTouchMove = d(b.tooltip.followTouchMove, !0)); this.setDOMEvents(); },
                    zoomOption: function (a) { var b = this.chart, c = b.options.chart, e = c.zoomType || "", b = b.inverted; /touch/.test(a.type) && (e = d(c.pinchType, e)); this.zoomX = a = /x/.test(e); this.zoomY = e = /y/.test(e); this.zoomHor = a && !b || e && b; this.zoomVert = e && !b || a && b; this.hasZoom = a || e; }, normalize: function (a, b) { var c; c = a.touches ? a.touches.length ? a.touches.item(0) : a.changedTouches[0] : a; b || (this.chartPosition = b = m(this.chart.container)); return n(a, { chartX: Math.round(c.pageX - b.left), chartY: Math.round(c.pageY - b.top) }); }, getCoordinates: function (a) {
                        var b = { xAxis: [], yAxis: [] };
                        t(this.chart.axes, function (c) { b[c.isXAxis ? "xAxis" : "yAxis"].push({ axis: c, value: c.toValue(a[c.horiz ? "chartX" : "chartY"]) }); });
                        return b;
                        ...
                        t(a, function (a) {
                            ...
                            a = a.searchPoint(d, h);
                            if ((h = b(a, !0)) && !(h = !b(e, !0)))
                                var h = e.distX - a.distX, k = e.dist - a.dist, p = (a.series.group && a.series.group.zIndex) - (e.series.group && e.series.group.zIndex), h = 0 < (0 !== h && c ? h : 0 !== k ? k : 0 !== p ? p : e.series.index >
                                    a.series.index ? -1 : 1);
                            h && (e = a);
                        });
                        return e;
                    }, getPointFromEvent: function (a) { a = a.target; for (var b; a && !b;)
                        b = a.point, a = a.parentNode; return b; }, getChartCoordinatesFromPoint: function (a, b) { var c = a.series, e = c.xAxis, c = c.yAxis, h = d(a.clientX, a.plotX); if (e && c)
                        return b ? { chartX: e.len + e.pos - h, chartY: c.len + c.pos - a.plotY } : { chartX: h + e.pos, chartY: a.plotY + c.pos }; }, getHoverData: function (c, h, k, f, m, l, n) {
                        ...
                        e && (m && !h.noSharedTooltip ? (n = a.grep(k, function (a) { return a.visible && !(!m && a.directTouch) && d(a.options.enableMouseTracking, !0) && !a.noSharedTooltip; }), t(n, function (a) { var c = v(a.points, function (a) { return a.x === e.x && !a.isNull; }); b(c) && (p && (c = a.getPoint(c)), x.push(c)); })) : x.push(e));
                        ...
                        if (p && (p !== e.hoverPoint || h && h.isHidden)) {
                            t(e.hoverPoints || [], function (b) { -1 === a.inArray(b, m) && b.setState(); });
                            t(m || [], function (a) { a.setState("hover"); });
                            if (e.hoverSeries !== f)
                                f.onMouseOver();
                            ...
                            c && h && !h.isHidden && (p = h.getAnchor([{}], b), h.updatePosition({ plotX: p[0], plotY: p[1] }));
                        this.unDocMouseMove || (this.unDocMouseMove = B(e.container.ownerDocument, "mousemove", function (b) { var c = E[a.hoverChartIndex]; if (c)
                            c.pointer.onDocumentMouseMove(b); }));
                        t(e.axes, function (c) { var e = d(c.crosshair.snap, !0), h = e ? a.find(m, function (a) { return a.series[c.coll] === c; }) : void 0; h || !e ? c.drawCrosshair(b, h) : c.hideCrosshair(); });
                    },
                    reset: function (a, b) {
                        var c = this.chart, d = c.hoverSeries, e = c.hoverPoint, k = c.hoverPoints, p = c.tooltip, f = p && p.shared ? k : e;
                        a && f && t(h(f), function (b) { b.series.isCartesian && void 0 === b.plotX && (a = !1); });
                        if (a)
                            p && f && (p.refresh(f), e && (e.setState(e.state, !0), t(c.axes, function (a) { a.crosshair && a.drawCrosshair(null, e); })));
                        else {
                            if (e)
                                e.onMouseOut();
                            k && t(k, function (a) { a.setState(); });
                            if (d)
                                d.onMouseOut();
                            p && p.hide(b);
                        ...
                        var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, h = this.zoomHor, k = this.zoomVert, f = b.plotLeft, x = b.plotTop, m = b.plotWidth, A = b.plotHeight, l, n = this.selectionMarker, g = this.mouseDownX, w = this.mouseDownY, t = c.panKey && a[c.panKey + "Key"];
                        n && n.touch || (d < f ? d = f : d > f + m && (d = f + m), e < x ? e = x : e > x + A && (e = x + A), this.hasDragged = Math.sqrt(Math.pow(g - d, 2) + Math.pow(w - e, 2)), 10 < this.hasDragged && (l = b.isInsidePlot(g - f, w - x), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !t && !n && (this.selectionMarker = n = b.renderer.rect(f, x, h ? 1 : m, k ? 1 : A, 0).attr({ fill: c.selectionMarkerFill || q("#335cad").setOpacity(.25).get(), "class": "highcharts-selection-marker", zIndex: 7 }).add()), n && h && (d -= g, n.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + g })), n && k && (d = e - w, n.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + w })), l && !n && c.panning && b.pan(a, c.panning)));
                    }, drop: function (a) {
                        ...
                        if (this.selectionMarker) {
                            ...
                            if (this.hasDragged || e)
                                t(d.axes, function (c) { if (c.zoomEnabled && l(c.min) && (e || b[{ xAxis: "zoomX", yAxis: "zoomY" }[c.coll]])) {
                                    ...
                                    A = !0;
                                } }), A && u(d, "selection", h, function (a) { d.zoom(n(a, e ? { animation: !1 } : null)); });
                    ...
                    onContainerClick: function (a) { var b = this.chart, c = b.hoverPoint, d = b.plotLeft, e = b.plotTop; a = this.normalize(a); b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (u(c.series, "click", n(a, { point: c })), b.hoverPoint && c.firePointEvent("click", a)) : (n(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && u(b, "click", a))); }, setDOMEvents: function () {
                        ...
                        a.hasTouch && (c.ontouchstart = function (a) { b.onContainerTouchStart(a); }, c.ontouchmove = function (a) { b.onContainerTouchMove(a); }, a.unbindDocumentTouchEnd || (a.unbindDocumentTouchEnd = B(d, "touchend", b.onDocumentTouchEnd)));
                    }, destroy: function () {
                        var b = this;
            ...
            (function (a) {
                ...
                E(a.Pointer.prototype, { pinchTranslate: function (a, f, l, q, c, b) {
                        ...
                        l = function () { !F && 20 < Math.abs(A - G) && (D = d || Math.abs(J - g) / Math.abs(A - G)); t = (n - J) / D + A; z = h["plot" + (a ? "Width" : "Height")] / D; };
                        l();
                        f = t;
                        ...
                        q(c, function (a) { return n.normalize(a); });
                        "touchstart" === a.type ? (H(c, function (a, b) {
                            u[b] = { chartX: a.chartX,
                                chartY: a.chartY };
                        }), m.x = [u[0].chartX, u[1] && u[1].chartX], m.y = [u[0].chartY, u[1] && u[1].chartY], H(t.axes, function (a) { if (a.zoomEnabled) {
                        ...
                        } }), n.res = !0) : n.followTouchMove && 1 === b ? this.runPointActions(n.normalize(a)) : u.length && (h || (n.selectionMarker = h = E({ destroy: f, touch: !0 }, t.plotBox)), n.pinchTranslate(u, c, k, h, p, m), n.hasPinched = d, n.scaleGroups(k, p), n.res && (n.res = !1, this.reset(!1, 0)));
                    }, touch: function (f, n) {
            ...
            (function (a) {
                ...
                if (!a.hasTouch && (v.PointerEvent || v.MSPointerEvent)) {
                    var c = {}, b = !!v.PointerEvent, m = function () {
                        ...
                        a.objectEach(c, function (a) { b.push({ pageX: a.pageX, pageY: a.pageY, target: a.target }); });
                        return b;
                    }, d = function (b, c, d, f) { "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !H[a.hoverChartIndex] || (f(b), f = H[a.hoverChartIndex].pointer, f[c]({ type: d, target: b.currentTarget, preventDefault: l, touches: m() })); };
                    f(t.prototype, { onContainerPointerDown: function (a) { d(a, "onContainerTouchStart", "touchstart", function (a) { c[a.pointerId] = { pageX: a.pageX, pageY: a.pageY, target: a.currentTarget }; }); },
                    ...
                    u(t.prototype, "init", function (a, b, c) { a.call(this, b, c); this.hasZoom && E(b.container, { "-ms-touch-action": "none", "touch-action": "none" }); });
                    u(t.prototype, "setDOMEvents", function (a) { a.apply(this); (this.hasZoom || this.followTouchMove) && this.batchMSEvents(B); });
                    u(t.prototype, "destroy", function (a) { this.batchMSEvents(n); a.call(this); });
                }
            })(K);
            (function (a) {
                var B = a.addEvent, H = a.css, E = a.discardElement, q = a.defined, f = a.each, l = a.isFirefox, t = a.marginNames, n = a.merge, v = a.pick, u = a.setAnimation, c = a.stableSort, b = a.win, m = a.wrap;
                a.Legend = function (a, b) { this.init(a, b); };
                a.Legend.prototype = { init: function (a, b) { this.chart = a; this.setOptions(b); b.enabled && (this.render(), B(this.chart, "endResize", function () { this.legend.positionCheckboxes(); })); }, setOptions: function (a) {
                        var b = v(a.padding, 8);
                        this.options = a;
                    ...
                    renderItem: function (a) {
                        ...
                        var a = this, b = a.chart, k = b.renderer, e = a.group, m, l, t, z, q = a.box, D = a.options, C = a.padding;
                        a.itemX = C;
                        ...
                        a.renderTitle();
                        m = a.getAllItems();
                        c(m, function (a, b) { return (a.options && a.options.legendIndex || 0) - (b.options && b.options.legendIndex || 0); });
                        D.reversed && m.reverse();
                        a.allItems = m;
                        a.display = l = !!m.length;
                        a.lastLineHeight = 0;
                        f(m, function (b) { a.renderItem(b); });
                        t =
                        ...
                        a.legendWidth = t;
                        a.legendHeight = z;
                        f(m, function (b) { a.positionItem(b); });
            ...
            (function (a) {
                ...
                d(P.prototype, { callbacks: [], getArgs: function () { var a = [].slice.call(arguments); if (I(a[0]) || a[0].nodeName)
                        ...
                        b[a] && (b[a].index = a, b[a].name = b[a].getName()); }, isInsidePlot: function (a, b, c) { var g = c ? b : a; a = c ? a : b; return 0 <= g && g <= this.plotWidth && 0 <= a && a <= this.plotHeight; }, redraw: function (b) {
                        ...
                        m(g, function (a) { a.isDirty && "point" === a.options.legendType && (a.updateTotals && a.updateTotals(), f = !0); a.isDirtyData && k(a, "updatedData"); });
                        f && h.options.enabled && (h.render(), this.isDirtyLegend = !1);
                        x && this.getStacks();
                        p && m(c, function (a) { a.updateNames(); a.setScale(); });
                        this.getMargins();
                        p && (m(c, function (a) { a.isDirty && (A = !0); }), m(c, function (a) {
                            var b = a.min + "," + a.max;
                            a.extKey !== b && (a.extKey = b, r.push(function () { k(a, "afterSetExtremes", d(a.eventArgs, a.getExtremes())); delete a.eventArgs; }));
                            (A || x) && a.redraw();
                        }));
                        A && this.drawChartBox();
                        k(this, "predraw");
                        m(g, function (a) { (A || a.isDirty) && a.visible && a.redraw(); a.isDirtyData = !1; });
                        e && e.reset(!0);
                        n.draw();
                        k(this, "redraw");
                        k(this, "render");
                        w && this.temporaryDisplay(!0);
                        m(r, function (a) { a.call(); });
                    }, get: function (a) {
                    ...
                    layOutTitles: function (a) {
                        ...
                        m(["title", "subtitle"], function (a) { var c = this[a], h = this.options[a]; a = "title" === a ? -3 : h.verticalAlign ? 0 : b + 2; var k; c && (k = h.style.fontSize, k = g.fontMetrics(k, c).b, c.css({ width: (h.width || e.width + h.widthAdjust) + "px" }).align(d({ y: a + k }, h), !1, "spacingBox"), h.floating || h.verticalAlign || (b = Math.ceil(b + c.getBBox(h.useHTML).height))); }, this);
                        ...
                        var c = this.spacing, g = this.margin, d = this.titleOffset;
                        this.resetMargins();
                        ...
                        m(M, function (d, e) { b(g[e]) || (a[d] += c[e]); });
                        a.setChartSize();
                    }, reflow: function (c) { var g = this, d = g.options.chart, e = g.renderTo, h = b(d.width) && b(d.height), k = d.width || a.getStyle(e, "width"), d = d.height || a.getStyle(e, "height"), e = c ? c.target : L; if (!h && !g.isPrinting && k && d && (e === L || e === f)) {
                        if (k !== g.containerWidth || d !== g.containerHeight)
                            clearTimeout(g.reflowTimeout), g.reflowTimeout = w(function () { g.container && g.setSize(void 0, void 0, !1); }, c ? 100 : 0);
                        g.containerWidth = k;
                        g.containerHeight = d;
                    } }, initReflow: function () {
                        var a = this, b;
                        b = B(L, "resize", function (b) { a.reflow(b); });
                        B(a, "destroy", b);
                        ...
                        m(e.axes, function (a) { a.isDirty = !0; a.setScale(); });
                        e.isDirtyLegend = !0;
                        e.isDirtyBox = !0;
                        e.layOutTitles();
                        e.getMargins();
                        ...
                        k(e, "resize");
                        w(function () { e && k(e, "endResize", null, function () { --e.isResizing; }); }, E(b).duration);
                    ...
                    }, propFromSeries: function () { var a = this, b = a.options.chart, c, g = a.options.series, d, e; m(["inverted", "angular", "polar"], function (h) { c = G[b.type || b.defaultSeriesType]; e = b[h] || c && c.prototype[h]; for (d = g && g.length; !e && d--;)
                        (c = G[g[d].type]) && c.prototype[h] && (e = !0); a[h] = e; }); }, linkSeries: function () {
                    ...
                    render: function () {
                        ...
                        if (d || e)
                            m(a, function (a) { (a.horiz && d || !a.horiz && e) && a.setTickInterval(!0); }), this.getMargins();
                        this.drawChartBox();
                        ...
                        a.enabled && !this.credits && (this.credits = this.renderer.text(a.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function () { a.href && (L.location.href = a.href); }).attr({ align: a.position.align,
                            zIndex: 8 }).css(a.style).add().align(a.position), this.credits.update = function (a) { b.credits = b.credits.destroy(); b.addCredits(a); });
                    }, destroy: function () {
                        ...
                        for (e = g.length; e--;)
                            g[e] = g[e].destroy();
                        m("title subtitle chartBackground plotBackground plotBGImage plotBorder seriesGroup clipRect credits pointer rangeSelector legend resetZoomButton tooltip renderer".split(" "), function (a) { var c = b[a]; c && c.destroy && (b[a] = c.destroy()); });
                        ...
                        m([this.callback].concat(this.callbacks), function (a) { a && void 0 !== this.index && a.apply(this, [this]); }, this);
                        k(this, "load");
                        k(this, "render");
            ...
            (function (a) {
                ...
                a.Point.prototype = { init: function (a, b, m) {
                    ...
                    }, getZone: function () { var a = this.series, b = a.zones, a = a.zoneAxis || "y", f = 0, d; for (d = b[f]; this[a] >= d.value;)
                        d = b[++f]; d && d.color && !this.options.color && (this.color = d.color); return d; }, destroy: function () { var a = this.series.chart, b = a.hoverPoints, f; a.pointCount--; b && (this.setState(), q(b, this), b.length || (a.hoverPoints = null)); if (this === a.hoverPoint)
                        this.onMouseOut(); if (this.graphic || this.dataLabel)
                        u(this), this.destroyElements(); this.legendItem && a.legend.destroyItem(this); for (f in this)
                        this[f] = null; }, destroyElements: function () {
                        ...
                        H(b.pointArrayMap || ["y"], function (b) { b = "{point." + b; if (h || k)
                            a = a.replace(b + "}", h + b + "}" + k); a = a.replace(b + "}", b + ":,." + d + "f}"); });
            ...
            (function (a) {
                ...
                a.Series = a.seriesType("line", null, { lineWidth: 2, allowPointSelect: !1, showCheckbox: !1, animation: { duration: 1E3 }, events: {}, marker: { lineWidth: 0, lineColor: "#ffffff", enabledThreshold: 2, radius: 4, states: { normal: { animation: !0 }, hover: { animation: { duration: 50 },
                    ...
                    }, insert: function (a) { var b = this.options.index, c; if (h(b)) {
                        for (c = a.length; c--;)
                        ...
                        a.push(this); return r(c, a.length - 1); }, bindAxes: function () {
                        var b = this, c = b.options, d = b.chart, e;
                        v(b.axisTypes || [], function (h) { v(d[h], function (a) { e = a.options; if (c[h] === e.index || void 0 !== c[h] && c[h] === e.id || void 0 === c[h] && 0 === e.index)
                            b.insert(a.series), b[h] = a, a.isDirty = !0; }); b[h] || b.optionalAxis === h || a.error(18, !0); });
                        ...
                        var a = this.options, b = this.xIncrement, c, d = a.pointIntervalUnit, e = this.chart.time, b = r(b, a.pointStart, 0);
                        ...
                        var m = this, g = m.points, l = g && g.length || 0, x, p = m.options, F = m.chart, n = null, A = m.xAxis, z = p.turboThreshold, q = this.xData, D = this.yData, t = (x = m.pointArrayMap) && x.length;
                        b = b || [];
                        x = b.length;
                        c = r(c, !0);
                        if (!1 !== f && x && l === x && !m.cropped && !m.hasGroupedData && m.visible)
                            v(b, function (a, b) { g[b].update && a !== p.data[b] && g[b].update(a, !1, null, !1); });
                        else {
                            m.xIncrement = null;
                            m.colorCounter = 0;
                            v(this.parallelArrays, function (a) { m[a + "Data"].length = 0; });
                            if (z && x > z) {
                                for (e = 0; null === n && e < x;)
                                    n = b[e], e++;
                                if (h(n))
                    ...
                    }, cropData: function (a, b, c, d) { var e = a.length, g = 0, h = e, k = r(this.cropShoulder, 1), f; for (f = 0; f < e; f++)
                        if (a[f] >= c) {
                            g = Math.max(0, f - k);
                            break;
                        } for (c = f; c < e; c++)
                        if (a[c] > d) {
                            h = c + k;
                            break;
                        } return { xData: a.slice(g, h), yData: b.slice(g, h), start: g, end: h }; }, generatePoints: function () {
                        var a = this.options, b = a.data, c = this.data, d, e = this.processedXData, g = this.processedYData, h = this.pointClass, k = e.length, f = this.cropStart || 0, m, l = this.hasGroupedData, a = a.keys, p, n = [], r;
                        ...
                        for (a = 0; a < m; a++) {
                            ...
                            C = I.low;
                            var H = c && k.stacks[(this.negStacks && E < (D ? 0 : q) ? "-" : "") + this.stackKey], K;
                        ...
                        var c = this.options.marker, e = a.marker || {}, d = e.symbol || c.symbol, g = r(e.radius, c.radius);
                        ...
                        b(a, "destroy");
                        I(a);
                        v(a.axisTypes || [], function (b) { (f = a[b]) && f.series && (u(f.series, a), f.isDirty = f.forceRedraw = !0); });
                        a.legendItem && a.chart.legend.destroyItem(a);
                        for (h = g.length; h--;)
                            (k = g[h]) && k.destroy && k.destroy();
                        a.points = null;
                        clearTimeout(a.animationTimeout);
                        p(a, function (a, b) { a instanceof M && !a.survive && (d = e && "group" === b ? "hide" : "destroy", a[d]()); });
                        ...
                        v(a, function (h, l) { var p = h.plotX, x = h.plotY, r = a[l - 1]; (h.leftCliff || r && r.rightCliff) && !c && (m = !0); h.isNull && !n(b) && 0 < l ? m = !d.connectNulls : h.isNull && !b ? m = !0 : (0 === l || m ? l = ["M", h.plotX, h.plotY] : e.getPointSpline ? l = e.getPointSpline(a, h, l) : g ? (l = 1 === g ? ["L", r.plotX, x] : 2 === g ? ["L", (r.plotX + p) / 2, r.plotY, "L", (r.plotX + p) / 2, x] : ["L", p, r.plotY], l.push("L", p, x)) : l = ["L", p, x], f.push(h.x), g && f.push(h.x), k.push.apply(k, l), m = !1); });
                        k.xMap = f;
                        return e.graphPath = k;
                    }, drawGraph: function () {
                        var a = this, b = this.options, c = (this.gappedPath ||
                            this.getGraphPath).call(this), e = [["graph", "highcharts-graph", b.lineColor || this.color, b.dashStyle]];
                        v(this.zones, function (c, d) { e.push(["zone-graph-" + d, "highcharts-graph highcharts-zone-graph-" + d + " " + (c.className || ""), c.color || a.color, c.dashStyle || b.dashStyle]); });
                        v(e, function (e, d) {
                            var g = e[0], h = a[g];
                        ...
                        h && a.animate();
                        f || (a.animationTimeout = D(function () { a.afterAnimate(); }, h));
                        a.isDirty = !1;
                        a.hasRendered = !0;
                        b(a, "afterRender");
                    }, redraw: function () {
                        ...
                        function a(c, e, d) {
                            var g, h;
                            if (h = c && c.length)
                                return g = b.kdAxisArray[e % d], c.sort(function (a, b) { return a[g] - b[g]; }), h = Math.floor(h / 2), { point: c[h], left: a(c.slice(0, h), e + 1, d), right: a(c.slice(h + 1), e + 1, d) };
                        }
            ...
            (function (a) {
                var B = a.Axis, H = a.Chart, E = a.correctFloat, q = a.defined, f = a.destroyObjectProperties, l = a.each, t = a.format, n = a.objectEach, v = a.pick, u = a.Series;
                a.StackItem = function (a, b, f, d, h) { var c = a.chart.inverted; this.axis = a; this.isNegative = f; this.options = b; this.x = d; this.total = null; this.points = {}; this.stack = h; this.rightCliff = this.leftCliff = 0; this.alignOptions = { align: b.align || (c ? f ? "left" : "right" : "center"), verticalAlign: b.verticalAlign || (c ? "middle" : f ? "bottom" : "top"), y: v(b.y, c ? 4 : f ? 14 : -6), x: v(b.x, c ? f ? -6 : 6 : 0) }; this.textAlign = b.textAlign || (c ? f ? "right" : "left" : "center"); };
                ...
                B.prototype.buildStacks = function () { var a = this.series, b = v(this.options.reversedStacks, !0), f = a.length, d; if (!this.isXAxis) {
                ...
                B.prototype.resetStacks = function () { var a = this, b = a.stacks; a.isXAxis || n(b, function (b) { n(b, function (c, h) { c.touched < a.stacksTouched ? (c.destroy(), delete b[h]) : (c.total = null, c.cumulative = null); }); }); };
                B.prototype.cleanStacks = function () { var a; this.isXAxis || (this.oldStacks && (a = this.stacks = this.oldStacks), n(a, function (a) { n(a, function (a) { a.cumulative = a.total; }); })); };
                ...
                u.prototype.modifyStacks = function () { var a = this, b = a.stackKey, f = a.yAxis.stacks, d = a.processedXData, h, k = a.options.stacking; a[k + "Stacker"] && l([b, "-" + b], function (b) { for (var c = d.length, e, l; c--;)
            ...
            (function (a) {
                ...
                v(a.Chart.prototype, { addSeries: function (a, b, c) { var d, h = this; a && (b = e(b, !0), u(h, "addSeries", { options: a }, function () { d = h.initSeries(a); h.isDirtyLegend = !0; h.linkSeries(); b && h.redraw(c); })); return d; }, addAxis: function (a, b, c, d) { var k = b ? "xAxis" : "yAxis", f = this.options; a = h(a, { index: this[k].length, isX: b }); b = new E(this, a); f[k] = M(f[k] || {}); f[k].push(a); e(c, !0) && this.redraw(d); return b; }, showLoading: function (a) {
                        ...
                        b && (b.className = "highcharts-loading highcharts-loading-hidden", H(b, { opacity: 0 }, { duration: a.loading.hideDuration || 100, complete: function () { f(b, { display: "none" }); } }));
                        this.loadingShown = !1;
                    ...
                    propsRequireUpdateSeries: "chart.inverted chart.polar chart.ignoreHiddenSeries chart.type colors plotOptions time tooltip".split(" "), update: function (a, d, f) {
                        ...
                        k(a, function (a, b) { if (p[b] && "function" === typeof p[b].update)
                            p[b].update(a, !1);
                        else if ("function" === typeof p[m[b]])
                            p[m[b]](a); "chart" !== b && -1 !== c(b, p.propsRequireUpdateSeries) && (g = !0); });
                        ...
                        t(z, function (a) { a.remove(!1); });
                        r && t(p.axes, function (a) { a.update({}, !1); });
                        g && t(p.series, function (a) { a.update({}, !1); });
                ...
                v(r.prototype, { addPoint: function (a, b, c, d) {
                        ...
                        var c = this, d = c.chart, k = c.userOptions, f = c.oldType || c.type, p = a.type || k.type || d.options.chart.type, g = I[f].prototype, l, m = ["group", "markerGroup", "dataLabelsGroup"], n = ["navigatorSeries", "baseSeries"], r = c.finishedAnimating && { animation: !1 };
                        if (Object.keys && "data" === Object.keys(a).toString())
                            return this.setData(a.data, b);
                        n = m.concat(n);
                        t(n, function (a) { n[a] = c[a]; delete c[a]; });
                        a = h(k, r, { index: c.index, pointStart: c.xData[0] }, { data: c.options.data }, a);
                        c.remove(!1, null, !1);
                        for (l in g)
                            c[l] = void 0;
                        v(c, I[p || f].prototype);
                        t(n, function (a) { c[a] = n[a]; });
                        c.init(d, a);
                        a.zIndex !== k.zIndex && t(m, function (b) { c[b] && c[b].attr({ zIndex: a.zIndex }); });
                        c.oldType = f;
                        d.linkSeries();
                        e(b, !0) && d.redraw(!1);
                    } });
                v(E.prototype, { update: function (a, b) { var c = this.chart; a = c.options[this.coll][this.options.index] = h(this.userOptions, a); this.destroy(!0); this.init(c, v(a, { events: void 0 })); c.isDirtyBox = !0; e(b, !0) && c.redraw(); }, remove: function (a) {
            ...
            (function (a) {
                ...
                l("area", "line", { softThreshold: !1, threshold: 0 }, { singleStacks: !1, getStackPoints: function (f) {
                        ...
                        if (this.options.stacking) {
                            ...
                            a.objectEach(b, function (a, b) { null !== a.total && t.push(b); });
                            t.sort(function (a, b) { return a - b; });
                            e = E(h, function () { return this.visible; });
                            H(t, function (a, h) {
                                var f = 0, n, z;
                                if (m[a] && !m[a].isNull)
                        ...
                        for (b = 0; b < a.length; b++)
                            if (m = a[b].isNull, e = q(a[b].rectPlotX, a[b].plotX), z = q(a[b].yBottom, I), !m || t)
                                t || M(b, b - 1, "left"), m && !u && t || (h.push(a[b]), d.push({ x: b, plotX: e, plotY: z })), t || M(b, b + 1, "right");
                        b = l.call(this, h, !0, !0);
                        d.reversed =
                            !0;
                        m = l.call(this, d, !0, !0);
                        ...
                        H(this.zones, function (c, b) { u.push(["zone-area-" + b, "highcharts-area highcharts-zone-area-" + b + " " + c.className, c.color || a.color, c.fillColor || v.fillColor]); });
                        H(u, function (c) {
                            var b = c[0], f = a[b];
            ...
            (function (a) {
                var B = a.seriesTypes.area.prototype, H = a.seriesType;
            ...
            (function (a) {
                ...
                v("column", "line", { borderRadius: 0, crisp: !0, groupPadding: .2, marker: null, pointPadding: .1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: { hover: { halo: !1, brightness: .1 },
                        select: { color: "#cccccc", borderColor: "#000000" } }, dataLabels: { align: null, verticalAlign: null, y: null }, softThreshold: !1, startFromThreshold: !0, stickyTracking: !1, tooltip: { distance: 6 }, threshold: 0, borderColor: "#ffffff" }, { cropShoulder: 0, directTouch: !0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () { n.prototype.init.apply(this, arguments); var a = this, b = a.chart; b.hasRendered && E(b.series, function (b) { b.type === a.type && (b.isDirty = !0); }); }, getColumnMetrics: function () {
                        var a = this, b = a.options, f = a.xAxis, d = a.yAxis, h = f.reversed, k, e = {}, l = 0;
                        !1 === b.grouping ? l = 1 : E(a.chart.series, function (b) { var c = b.options, h = b.yAxis, f; b.type !== a.type || !b.visible && a.chart.options.chart.ignoreHiddenSeries || d.len !== h.len || d.pos !== h.pos || (c.stacking ? (k = b.stackKey, void 0 === e[k] && (e[k] = l++), f = e[k]) : !1 !== c.grouping && (f = l++), b.columnIndex = f); });
                        var n = Math.min(Math.abs(f.transA) * (f.ordinalSlope || b.pointRange || f.closestPointRange || f.tickInterval || 1), f.len), q = n * b.groupPadding, z = (n - 2 * q) / (l || 1), b = Math.min(b.maxPointWidth || f.len, t(b.pointWidth, z * (1 - 2 * b.pointPadding)));
                        ...
                        var a = this, b = a.chart, f = a.options, d = a.dense = 2 > a.closestPointRange * a.xAxis.transA, d = a.borderWidth = t(f.borderWidth, d ? 0 : 1), h = a.yAxis, k = f.threshold, e = a.translatedThreshold = h.getThreshold(k), l = t(f.minPointLength, 5), r = a.getColumnMetrics(), q = r.width, z = a.barW = Math.max(q, 1 + 2 * d), u = a.pointXOffset = r.offset;
                        b.inverted && (e -= .5);
                    ...
                    pointAttribs: function (a, b) {
                        ...
                        var a = this, b = a.chart;
                        b.hasRendered && E(b.series, function (b) { b.type === a.type && (b.isDirty = !0); });
                        n.prototype.remove.apply(a, arguments);
                    } });
            })(K);
            (function (a) { a = a.seriesType; a("bar", "column", null, { inverted: !0 }); })(K);
            (function (a) {
                var B = a.Series;
                a = a.seriesType;
            ...
            (function (a) {
                ...
                a.CenteredSeriesMixin = { getCenter: function () {
                        var a = this.options, l = this.chart, t = 2 * (a.slicedOffset || 0), n = l.plotWidth - 2 * t, l = l.plotHeight - 2 * t, v = a.center, v = [E(v[0], "50%"), E(v[1], "50%"), a.size || "100%", a.innerSize || 0], u = Math.min(n, l), c, b;
                        for (c = 0; 4 > c; ++c)
            ...
            (function (a) {
                ...
                b("pie", "line", { center: [null, null], clip: !1, colorByPoint: !0, dataLabels: { distance: 30,
                        ...
                        a || (q(c, function (a) { var c = a.graphic, e = a.shapeArgs; c && (c.attr({ r: a.startR || b.center[3] / 2, start: d, end: d }), c.animate({ r: e.r, start: e.start, end: e.end }, b.options.animation)); }), b.animate = null);
                    }, updateTotals: function () { var a, b = 0, c = this.points, e = c.length, f, l = this.options.ignoreHiddenPoint; for (a = 0; a < e; a++)
                        f = c[a], b += l && !f.visible ? 0 : f.isNull ? 0 : f.y; this.total = b; for (a = 0; a < e; a++)
                        f = c[a], f.percentage = 0 < b && (f.visible || !l) ? f.y / b * 100 : 0, f.total = b; }, generatePoints: function () {
                        ...
                        this.getX = function (b, c, e) { n = Math.asin(Math.min((b - a[1]) / (a[2] / 2 + e.labelDistance), 1)); return a[0] + (c ? -1 : 1) * Math.cos(n) * (a[2] / 2 + e.labelDistance); };
                        for (A = 0; A < B; A++) {
                            G = u[A];
                    ...
                    sortByAngle: function (a, b) { a.sort(function (a, c) { return void 0 !== a.angle && (c.angle - a.angle) * b; }); }, drawLegendSymbol: a.LegendSymbolMixin.drawRectangle, getCenter: H.getCenter, getSymbol: n }, { init: function () { u.prototype.init.apply(this, arguments); var a = this, b; a.name = v(a.name, "Slice"); b = function (b) { a.slice("select" === b.type); }; B(a, "select", b); B(a, "unselect", b); return a; }, isValid: function () { return a.isNumber(this.y, !0) && 0 <= this.y; }, setVisible: function (a, b) {
                        var c = this, e = c.series, d = e.chart, h = e.options.ignoreHiddenPoint;
                        b = v(b, h);
                        a !== c.visible && (c.visible = c.options.visible = a = void 0 === a ? !c.visible : a, e.options.data[t(c, e.data)] = c.options, q(["graphic", "dataLabel", "connector", "shadowGroup"], function (b) { if (c[b])
                            c[b][a ? "show" : "hide"](!0); }), c.legendItem && d.legend.colorizeItem(c, a), a || "hover" !== c.state || c.setState(""), h && (e.isDirty = !0), b && d.redraw());
            ...
            (function (a) {
                var B = a.addEvent, H = a.arrayMax, E = a.defined, q = a.each, f = a.extend, l = a.format, t = a.map, n = a.merge, v = a.noop, u = a.pick, c = a.relativeLength, b = a.Series, m = a.seriesTypes, d = a.stableSort;
                a.distribute = function (a, b) {
                    ...
                    f = 0;
                    q(a, function (a) { var b = 0; q(a.targets, function () { k[f].pos = a.pos + b; b += k[f].size; f++; }); });
                    k.push.apply(k, l);
                    d(k, c);
                };
                ...
                b.prototype.alignDataLabel = function (a, b, c, d, l) {
                    ...
                    if (t && (p = c.style.fontSize, p = e.renderer.fontMetrics(p, b).b, d = f({ x: h ? this.yAxis.len - m : k, y: Math.round(h ? this.xAxis.len - k : m), width: 0, height: 0 }, d), f(c, { width: n.width, height: n.height }), q ? (v = !1, k = e.renderer.rotCorr(p, q), k = { x: d.x + c.x + d.width / 2 + k.x, y: d.y + c.y + { top: 0, middle: .5, bottom: 1 }[c.verticalAlign] * d.height }, b[l ? "attr" : "animate"](k).attr({ align: r }), m = (q + 720) % 360, m = 180 < m && 360 > m, "left" === r ? k.y -= m ? n.height : 0 : "center" === r ? (k.x -= n.width / 2, k.y -= n.height /
                        ...
                        b[l ? "attr" : "animate"]({ anchorX: h ? e.plotWidth - a.plotY : a.plotX, anchorY: h ? e.plotHeight - a.plotX : a.plotY });
                ...
                m.pie && (m.pie.prototype.drawDataLabels = function () {
                    ...
                    c.visible && (l.enabled || c._hasPointLabels) && (q(d, function (a) { a.dataLabel && a.visible && a.dataLabel.shortened && (a.dataLabel.attr({ width: "auto" }).css({ width: "auto", textOverflow: "clip" }), a.dataLabel.shortened = !1); }), b.prototype.drawDataLabels.apply(c), q(d, function (a) { a.dataLabel && a.visible && (L[a.half].push(a), a.dataLabel._pos = null); }), q(L, function (b, d) {
                        ...
                        if ((B = a.dataLabel) && B._pos && a.visible && 0 < a.labelDistance) {
                            ...
                            if (b = !C)
                                a.connector = C = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(c.dataLabelsGroup), C.attr({ "stroke-width": n, stroke: l.connectorColor || a.color || "#666666" });
            ...
            (function (a) {
                ...
                a(B.prototype, "render", function () {
                    var a = [];
                    H(this.labelCollectors || [], function (f) { a = a.concat(f()); });
                    H(this.yAxis || [], function (f) { f.options.stackLabels && !f.options.stackLabels.allowOverlap && E(f.stacks, function (f) { E(f, function (f) { a.push(f.label); }); }); });
                    H(this.series || [], function (f) { var l = f.options.dataLabels, n = f.dataLabelCollections || ["dataLabel"]; (l.enabled || f._hasPointLabels) && !l.allowOverlap && f.visible && H(n, function (l) { H(f.points, function (f) { f[l] && (f[l].labelrank = q(f.labelrank, f.shapeArgs && f.shapeArgs.height), a.push(f[l])); }); }); });
                    this.hideOverlappingLabels(a);
                });
                B.prototype.hideOverlappingLabels =
                    function (a) {
                        var f = a.length, q, n, v, u, c, b, m, d, h, k = function (a, b, c, d, f, h, k, l) { return !(f > a + c || f + k < a || h > b + d || h + l < b); };
                        for (n = 0; n < f; n++)
                            if (q = a[n])
            ...
            (function (a) {
                var B = a.addEvent, H = a.Chart, E = a.createElement, q = a.css, f = a.defaultOptions, l = a.defaultPlotOptions, t = a.each, n = a.extend, v = a.fireEvent, u = a.hasTouch, c = a.inArray, b = a.isObject, m = a.Legend, d = a.merge, h = a.pick, k = a.Point, e = a.Series, p = a.seriesTypes, r = a.svg, I;
                I = a.TrackerMixin = { drawTrackerPoint: function () {
                        ...
                        var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, h = f.pointer, k = f.renderer, l = f.options.tooltip.snap, g = a.tracker, m, n = function () { if (f.hoverSeries !== a)
                            a.onMouseOver(); }, p = "rgba(192,192,192," + (r ? .0001 : .002) + ")";
                        if (e && !c)
                            for (m = e + 1; m--;)
                                "M" ===
                ...
                n(m.prototype, { setItemEvents: function (a, b, c) {
                        ...
                        (c ? b : a.legendGroup).on("mouseover", function () { a.setState("hover"); f.addClass(h); b.css(e.options.itemHoverStyle); }).on("mouseout", function () {
                            b.css(d(a.visible ?
                        ...
                        B(a.checkbox, "click", function (b) {
                            v(a.series || a, "checkboxClick", { checked: b.target.checked,
                                item: a }, function () { a.select(); });
                        });
                    } });
                f.legend.itemStyle.cursor = "pointer";
                n(H.prototype, { showResetZoom: function () { function a() { b.zoomOut(); } var b = this, c = f.lang, d = b.options.chart.resetZoomButton, e = d.theme, h = e.states, k = "chart" === d.relativeTo ? null : "plotBox"; v(this, "beforeShowResetZoom", null, function () { b.resetZoomButton = b.renderer.button(c.resetZoom, null, null, a, e, h && h.hover).attr({ align: d.position.align, title: c.resetZoomTitle }).addClass("highcharts-reset-zoom").add().align(d.position, !1, k); }); }, zoomOut: function () {
                        var a = this;
                        v(a, "selection", { resetSelection: !0 }, function () { a.zoom(); });
                    }, zoom: function (a) { var c, d = this.pointer, e = !1, f; !a || a.resetSelection ? (t(this.axes, function (a) { c = a.zoom(); }), d.initiated = !1) : t(a.xAxis.concat(a.yAxis), function (a) { var b = a.axis; d[b.isXAxis ? "zoomX" : "zoomY"] && (c = b.zoom(a.min, a.max), b.displayBtn && (e = !0)); }); f = this.resetZoomButton; e && !f ? this.showResetZoom() : !e && b(f) && (this.resetZoomButton = f.destroy()); c && this.redraw(h(this.options.chart.animation, a && a.animation, 100 > this.pointCount)); }, pan: function (a, b) {
                ...
                n(e.prototype, { onMouseOver: function () { var a = this.chart, b = a.hoverSeries; if (b && b !== this)
                        ...
                        a = a || "";
                        if (b.state !== a && (t([b.group, b.markerGroup, b.dataLabelsGroup], function (c) { c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a)); }), b.state = a, !e[a] || !1 !== e[a].enabled) &&
            ...
            (function (a) {
                ...
                B.prototype.setResponsive = function (f) {
                    ...
                    l && l.rules && H(l.rules, function (b) { void 0 === b._id && (b._id = a.uniqueKey()); this.matchResponsiveRule(b, n, f); }, this);
                    var b = a.merge.apply(0, a.map(n, function (b) { return a.find(l.rules, function (a) { return a._id === b; }).chartOptions; })), n = n.toString() || void 0;
                    n !== (c && c.ruleIds) &&
                ...
                B.prototype.matchResponsiveRule = function (a, f) { var n = a.condition; (n.callback || function () { return this.chartWidth <= l(n.maxWidth, Number.MAX_VALUE) && this.chartHeight <= l(n.maxHeight, Number.MAX_VALUE) && this.chartWidth >= l(n.minWidth, 0) && this.chartHeight >= l(n.minHeight, 0); }).call(this) && f.push(a._id); };
                B.prototype.currentOptions = function (l) {
                    function n(c, b, l, d) { var h; a.objectEach(c, function (a, c) { if (!d && -1 < E(c, ["series", "xAxis", "yAxis"]))
