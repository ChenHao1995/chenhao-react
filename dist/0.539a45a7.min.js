...
var _demo = __webpack_require__(577);

var _demo2 = _interopRequireDefault(_demo);

var _indexMin = __webpack_require__(505);

var _indexMin2 = _interopRequireDefault(_indexMin);

var _totalPoints = __webpack_require__(578);

var _totalPoints2 = _interopRequireDefault(_totalPoints);

var _redux = __webpack_require__(124);

var _reactRouterRedux = __webpack_require__(125);

var _createReactClass = __webpack_require__(579);
...
var Demo = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = function (_Component) {
  ...
  function Demo(props) {
    ...
    _this.onhref = function () {
      ...
      console.log(_reactRouterRedux.push);
    ...
    _this.state = {
      ScoreStart: (0, _createReactClass2.default)({
  ...
  _createClass(Demo, [{
    ...
    key: 'remarkChange',
    value: function remarkChange(value) {
    ...
    key: 'recommendChange',
    value: function recommendChange(value) {
    ...
    value: function submit() {
      console.log(_propTypes.PropTypes);
      var _props = this.props,
          totalValue = _props.totalValue,
          scoreToStartForm = _props.scoreToStartForm,
          remarkValue = _props.remarkValue;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_totalPoints2.default, { maxvalue: 15 }),
          _react2.default.createElement(
            'span',
            null,
            '\u5206\u503C\uFF0815\u5206\uFF09'
        ...
        dataArray.map(function (value, index, array) {
          return _react2.default.createElement(ScoreStart, {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('textarea', {
              ...
              onChange: function onChange(e) {
                _this3.remarkChange(e.target.value);
              }
            })
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(_switch2.default, {
            checked: checked,
            onChange: function onChange(e) {
              _this3.recommendChange(!checked);
            }
          })
        ),
        _react2.default.createElement(
...
Demo.propTypes = {
  remark: _propTypes.PropTypes.any,
  recommend: _propTypes.PropTypes.any,
  totalValue: _propTypes.PropTypes.any,
  scoreToStartForm: _propTypes.PropTypes.any,
  remarkValue: _propTypes.PropTypes.any,
  checked: _propTypes.PropTypes.any,
  children: _propTypes.PropTypes.any,
  actions: _propTypes.PropTypes.object,
  routerActions: _propTypes.PropTypes.object
};
...
var anObject = __webpack_require__(484);
var IE8_DOM_DEFINE = __webpack_require__(507);
var toPrimitive = __webpack_require__(491);
var dP = Object.defineProperty;

exports.f = __webpack_require__(477) ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  anObject(O);
...
var hide = __webpack_require__(480);
...
module.exports = __webpack_require__(477) ? function (object, key, value) {
...
var store = __webpack_require__(495)('wks');
var uid = __webpack_require__(489);
var Symbol = __webpack_require__(474).Symbol;
...
var _demoActions = __webpack_require__(504);

var demoActions = _interopRequireWildcard(_demoActions);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

exports.default = _extends({}, demoActions);
...
var shared = __webpack_require__(495)('keys');
var uid = __webpack_require__(489);
module.exports = function (key) {
...
var enumBugKeys = __webpack_require__(496);
var IE_PROTO = __webpack_require__(494)('IE_PROTO');
...
var TAG = __webpack_require__(483)('toStringTag');
...
exports.f = __webpack_require__(483);
...
var defineProperty = __webpack_require__(476).f;
...
module.exports = !__webpack_require__(477) && !__webpack_require__(485)(function () {
...
var isObject = __webpack_require__(481);
var document = __webpack_require__(474).document;
...
var has = __webpack_require__(478);
var toIObject = __webpack_require__(482);
...
var setToStringTag = __webpack_require__(501);
var getPrototypeOf = __webpack_require__(545);
var ITERATOR = __webpack_require__(483)('iterator');
...
var $keys = __webpack_require__(509);
var hiddenKeys = __webpack_require__(496).concat('length', 'prototype');
...
exports.f = __webpack_require__(477) ? gOPD : function getOwnPropertyDescriptor(O, P) {
  O = toIObject(O);
  P = toPrimitive(P, true);
  if (IE8_DOM_DEFINE) try {
    return gOPD(O, P);
...
var _defineProperty2 = __webpack_require__(532);
...
var _classnames3 = __webpack_require__(568);
...
var gOPS = __webpack_require__(497);
var pIE = __webpack_require__(490);
var toObject = __webpack_require__(512);
var IObject = __webpack_require__(510);
...
$export($export.S + $export.F * !__webpack_require__(477), 'Object', { defineProperty: __webpack_require__(476).f });
...
module.exports = __webpack_require__(502).f('iterator');
...
__webpack_require__(480)(IteratorPrototype, __webpack_require__(483)('iterator'), function () { return this; });
...
module.exports = __webpack_require__(477) ? Object.defineProperties : function defineProperties(O, Properties) {
  anObject(O);
...
var hide = __webpack_require__(480);
var Iterators = __webpack_require__(499);
var TO_STRING_TAG = __webpack_require__(483)('toStringTag');
...
module.exports = __webpack_require__(475).Symbol;
...
var global = __webpack_require__(474);
var has = __webpack_require__(478);
var DESCRIPTORS = __webpack_require__(477);
var $export = __webpack_require__(479);
var redefine = __webpack_require__(516);
var META = __webpack_require__(553).KEY;
var $fails = __webpack_require__(485);
var shared = __webpack_require__(495);
var setToStringTag = __webpack_require__(501);
var uid = __webpack_require__(489);
var wks = __webpack_require__(483);
var wksExt = __webpack_require__(502);
...
var $GOPD = __webpack_require__(518);
var $DP = __webpack_require__(476);
...
if (!USE_NATIVE) {
  ...
  $DP.f = $defineProperty;
  __webpack_require__(517).f = gOPNExt.f = $getOwnPropertyNames;
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(480)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
var isObject = __webpack_require__(481);
var has = __webpack_require__(478);
var setDesc = __webpack_require__(476).f;
var id = 0;
...
var toIObject = __webpack_require__(482);
var gOPN = __webpack_require__(517).f;
var toString = {}.toString;
...
__webpack_require__(503)('asyncIterator');
...
__webpack_require__(503)('observable');
...
module.exports = __webpack_require__(475).Object.setPrototypeOf;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(506)(Function.call, __webpack_require__(518).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var TotalPoints = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = function (_Component) {
  _inherits(TotalPoints, _Component);

  function TotalPoints(props) {
    _classCallCheck(this, TotalPoints);

    //console.log(this.props)
    var _this = _possibleConstructorReturn(this, (TotalPoints.__proto__ || Object.getPrototypeOf(TotalPoints)).call(this, props));
  ...
  _createClass(TotalPoints, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('input', { type: 'number', min: '0', className: 'input-text', value: totalValue, onChange: function onChange(e) {
...
TotalPoints.propTypes = {
  totalValue: _propTypes.PropTypes.any,
  maxvalue: _propTypes.PropTypes.number,
  totalvalue: _propTypes.PropTypes.any,
  actions: _propTypes.PropTypes.object
  // const Total = connect(
  //   mapStateToProps,
