...
export default class ScoreToStart extends Component {
  ...
  render(){
    ...
    const scoreValue = this.props.scoreToStartForm ? (this.props.scoreToStartForm[propkey] ? this.props.scoreToStartForm[propkey].value : '') : ''
    const startCount = this.props.scoreToStartForm ? (this.props.scoreToStartForm[propkey] ? this.props.scoreToStartForm[propkey].startCount : '') : ''
    return(
        ...
        <div className='score-box'>
          <div className='start-box' >
            <div className={startCount >= 0.5 ? (startCount >= 1 ? 'start-l cf': 'start-yb cf'): 'start cf'}>
              <div className='start-click' onClick={(e)=>{
